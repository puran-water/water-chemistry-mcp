...
DATABASE_ISSUES = {
    "phreeqc.dat": [
        {"issue": "Missing Ferrihydrite mineral", "workaround": "Use Fe(OH)3(a) instead of Ferrihydrite"},
        {"issue": "Limited heavy metal species", "workaround": "Use wateq4f.dat for heavy metal calculations"},
    ],
    "wateq4f.dat": [
        {
    ...
    "pitzer.dat": [
        ...
        {"issue": "Not suitable for redox calculations", "workaround": "Use wateq4f.dat for redox-sensitive systems"},
    ],
}
...
def get_custom_database_metadata(
