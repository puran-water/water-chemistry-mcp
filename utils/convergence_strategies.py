...
"""
            ...
            if eq_match:
                ...
                for mineral in essential_minerals:
                    if mineral.lower() in eq_block.lower():
                        ...
                        mineral_match = re.search(f'{mineral}.*$', eq_block, 
    ...
    def add_background_electrolyte(input_string: str) -> str:
        ...
        if solution_match:
            ...
            if additions:
                ...
                new_solution = (solution_block[:insertion_point] + '\n' + 
                              '\n'.join(additions) + 
    ...
    def switch_to_pitzer_database(input_string: str, current_database: str) -> Optional[str]:
        ...
        if total_conc > 10000:
            logger.info(f"High ionic strength detected (total conc: {total_conc} mg/L). "
                       f"Suggesting PITZER database.")
            return "pitzer.dat"
