...
PHREEQC_RATES_MINERALS = {
    ...
    "Albite": {
        ...
        "mechanisms": ["H+", "H2O", "OH-", "CO2"],
        "parameters": {
            "parm1": "Specific area, m²/mol",
            "parm2": "Field rate adjustment factor"
        },
        "example_parms": [6.41, 0.1],
    ...
    "Calcite": {
        ...
        "parameters": {
            "parm1": "Specific surface area, cm²/mol calcite",
            "parm2": "Exponent for M/M0 (typically 0.6)"
        },
    ...
    "Organic_C": {
        ...
        "parameters": {
            "parm1": "Initial concentration C_0, mol/kgw",
            "parm2": "Rate constant, 1/s"
        },
    ...
    "Pyrolusite": {
        ...
        "parameters": {
            "parm1": "Specific surface area, m²/g pyrolusite",
            "parm2": "Exponent for (M/M0)"
        },
...
def format_for_mcp_input(mineral: str, surface_area: float = 1.0, 
                        field_factor: float = 1.0) -> Dict[str, Any]:
    """
