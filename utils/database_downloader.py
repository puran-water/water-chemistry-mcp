...
def download_database(database_name: str, force_update: bool = False, 
...
def download_all_official_databases(force_update: bool = False, 
...
def import_custom_database(source_path: str, name: Optional[str] = None, 
