...
async def simulate_solution_mixing(input_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        if allow_precipitation:
            ...
            logger.info(
                f"Selected minerals for precipitation based on water chemistry: {', '.join(compatible_minerals)}"
            )
            ...
            if compatible_minerals:
                ...
                # Use allow_empty=True since having no valid phases is acceptable here
