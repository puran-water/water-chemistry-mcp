...
def cache_database_info(database_path: str, database_info: Dict[str, Any], 
                       cache_type: str = 'database_info') -> str:
    """
...
def cache_mineral_compatibility(database_path: str, minerals: List[str], result: Dict[str, Any]) -> None:
    ...
    cache_path = os.path.join(CACHED_DIR, cache_type, 
                             f"{os.path.basename(database_path)}_{minerals_hash}.json")
